...
import SignUpGoogleI from "./Auth/SignUpI.jsx";
...
class App extends Component {
  ...
  runExample = async () => {
    ...
    await this.state.contract.methods.set(120).send({ from: this.state.accounts[0] });
    ...
    .createNewMultiSigbyUser(this.state.accounts[0])
    .send({ from: this.state.accounts[0] });

    await this.state.contract.methods.uploadAadhar("PURE").send({ from: this.state.accounts[0] });

    var res = await this.state.contract.methods.getAadhar().call();
  };
